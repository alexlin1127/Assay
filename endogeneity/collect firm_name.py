...
def main():
    input_dir = r'/Users/alex/Desktop/0511assay data測試/issue date news拷貝' # 記得變更路徑
    issue_dir_data = r'/Users/alex/Desktop/0511assay data測試/news without date' # 這個也要
    ...
    print("Files with issues (no dates or date problems):", files_with_issues_data)
